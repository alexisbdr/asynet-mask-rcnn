...
from asynet_mask_rcnn.data.datasets.abstract import AbstractDataset
...
def convert_abstract_to_coco(dataset, num_workers=None, chunksize=100):
    ...
    and loads it with the asynet_mask_rcnn's default COCODataset
