...
from asynet_mask_rcnn.modeling.roi_heads.mask_head.inference import Masker
...
from asynet_mask_rcnn.data.datasets.evaluation.cityscapes import eval_instances
...
def do_cityscapes_evaluation(
    ...
    logger = logging.getLogger("asynet_mask_rcnn.inference")
