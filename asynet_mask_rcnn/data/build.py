...
from asynet_mask_rcnn.utils.comm import get_world_size
from asynet_mask_rcnn.utils.imports import import_file
from asynet_mask_rcnn.utils.miscellaneous import save_labels
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False):
    ...
    paths_catalog = import_file(
        "asynet_mask_rcnn.config.paths_catalog", cfg.PATHS_CATALOG, True
    )
