...
from asynet_mask_rcnn.utils.comm import get_world_size, synchronize
from asynet_mask_rcnn.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("asynet_mask_rcnn.trainer")
